...
<head>
    ...
    <title>Mahastore Admin | Buat  Produk</title>
                            ...
                            <div class="table-responsive">
                                <form action="" method="post" id="product-form" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="summernote" class="form-control"  name="deskripsi" ></textarea>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>Sudah Habis</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
