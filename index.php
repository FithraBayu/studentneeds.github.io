...
<head>
    ...
    <title>StudentNeeds.co | Website keperluan Cendekiawan</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav">
                    <li class="nav-item"><a href="index.php" class="nav-link"><i class='bx bxs-store' style="color:red;"></i> StudentNeeds.co</a></li>
                </ul>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false" style="margin: auto; padding: 10px; max-width: 1000px; ">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-caption d-none d-md-block">
                <h6>Selamat Datang di StudentNeeds.co</h6>
                <p>StudentNeeds.co adalah toko online yang menyediakan keperluan pelajar cendekiawan</p>
            </div>
            </div>
            ...
            <div class="carousel-caption d-none d-md-block">
                ...
                <p>StudentNeeds.co menjual produk berkualitas dengan harga yang sesuai dengan pelajar</p>
            </div>
            </div>
            <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
                ...
                <p>StudentNeeds.co memiliki kurir khusus yang di rekrut dari mahasiswa sehingga antar barang akan semakin cepat </p>
            </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card" style="width: 14rem;">
                            ...
                            <div class="card-body">
                                <p style="font-size: 20px;" class="card-title"><?= $row["nama_barang"]; ?></p>
...
<footer class="sticky-footer bg-black" style="padding: 30px;">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; Cendekiawan Media</span>
        </div>
    </div>
</footer>
</html>