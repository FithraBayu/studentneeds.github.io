...
<head>
    ...
    <title>StudentNeeds.co | About Us </title>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <h1 class="" style="font-size: 60px;">StudentNeeds.co</h1>
              <h5 class="">Toko online Cendekiawan</h5>
              <a
      ...
      <section class="store-adventeges" id="adventeges">
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              <h2 class="font-weight-bold mb-2">StudentNeeds.co</h2>   
          </div>
          <div class="row text-center">
            <div class="col-md-12">
              <p>StudentNeeds.co merupakan website yang didirikan oleh mahasiswa untuk membantu para mahasiswa 
                  dalam bidang pendidikan,perdagangan, dan pekerjaan. StudentNeeds.co berkantor di Purwakarta. 
                  saat ini StudentNeeds.co berfokus untuk membantu mahasiswa Universitas Singaperbangsa Karawang dalam 
